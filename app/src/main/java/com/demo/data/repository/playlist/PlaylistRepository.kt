...
class PlaylistRepository(private val retrofitCLient: RetrofitClient): IPlaylistRepository {
    override fun getPlaylist(
        accessToken: String,
        playlistId: String,
        onSuccess: (Playlists?) -> Unit
    ) {
        val playlistCall = retrofitCLient.instance.getPlaylist(
            id = playlistId,
        ...
        playlistCall.enqueue(
            object : Callback<AccessPlaylist> {
                ...
                override fun onFailure(call: Call<AccessPlaylist>, t: Throwable) {
